...
// Matches the NEW PULSE_DATA shape (LLM Overwatch pivot).
...
(function () {
  ...
  var models = [
    { name: 'anthropic-claude-3-7-sonnet-thinking', status: 'unknown',
      metrics: { last15MinAverage: 55000, allTimeAverage: 42000 },
    ...
    { name: 'anthropic-claude-haiku-3.5', status: 'unknown',
      metrics: { last15MinAverage: 11000, allTimeAverage: 10500 },
    ...
    { name: 'anthropic-claude-sonnet-4-5', status: 'unknown',
      metrics: { last15MinAverage: 26000, allTimeAverage: 17000 },
